function loadf(moves)
{
	...
	for( i = 0 ; i < movearray.length ; i++)
	{
		...
		{			
			...
			//open for
			case ')': $( "#editorspace ul" ).append(
						$("<li id=\"moveforopen\" class=\"command\"><div id=\"movediv\">For: <select id=\"moveforopenfirstlist\"><option value=\"i\">i</option><option value=\"j\">j</option><option value=\"k\">k</option></select>=<input type=\"number\" name=\"edittxt\" id=\"edittxt\" value="+number.substring(1)+" max=\"999\" min=\"-999\" />;<select id=\"moveforopensecondlist\"><option value=\">\">></option><option value=\"<\"><</option><option value=\"=\">=</option></select><input type=\"number\" name=\"edittxt\" id=\"edittxt2\" value="+ movearray[(i+1)].val().substring(2) +" max=\"999\" min=\"-999\" />;<select id=\"moveforopenthirdlist\"><option value=\"+\">+</option><option value=\"-\">-</option><option value=\"*\">*</option><option value=\"/\">/</option><option value=\"%\">%</option></select><input type=\"number\" name=\"edittxt\" id=\"edittxt3\" value="+ movearray[(i+2)].val().substring(2) +" max=\"999\" min=\"-999\" /></div></li>"));
