	...
	for( i = 0 ; i < movearray.length ; i++)
	{
		...
		{			
			...
			case 'U': $( "#editorspace ul" ).append(
						$("<li id=\"moveup\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">MOVE UP: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//down
			case 'D': $( "#editorspace ul" ).append(
						$("<li id=\"movedown\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">MOVE DOWN: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//left
			case 'L': $( "#editorspace ul" ).append(
						$("<li id=\"moveleft\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">MOVE LEFT: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//right
			case 'R': $( "#editorspace ul" ).append(
						$("<li id=\"moveright\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">MOVE RIGHT: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//open loop
			case 'O': $( "#editorspace ul" ).append(
						$("<li id=\"moveloopo\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">OPEN LOOP</div></li>"));
				break;
				
			//close loop
			case 'C': $( "#editorspace ul" ).append(
						$("<li id=\"moveloopc\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">CLOSE LOOP: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
			
			//set X
			case 'X': $( "#editorspace ul" ).append(
						$("<li id=\"movesetx\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">SET X: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>")); 
				break;
				
			//set y
			case 'Y': $( "#editorspace ul" ).append(
						$("<li id=\"movesety\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">SET Y: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;			
				
			//change character
			case 'A': $( "#editorspace ul" ).append(
						$("<li id=\"movechangechar\" class=\"command ui-draggable-handle item\"><select id=\"defaultCharListCom\" class=\"characterSelected\"><option value=\"\" disabled selected>Change char</option><option value=\"1\">Yellow Mouse</option><option value=\"2\">Orange Lizard</option><option value=\"3\">Green Elf</option><option value=\"4\">Blue Turtle</option><option value=\"5\">Larry</option></select></li>"));
			...
			case 'T': $( "#editorspace ul" ).append(
						$("<li id=\"movechartoggle\" class=\"command ui-draggable-handle item\">	<div id=\"movediv\">Toggle character</div></li>"));
				break;
			...
			//close if	
			case '}': $( "#editorspace ul" ).append(
						$("<li id=\"moveifclose\" class=\"command ui-draggable-handle item\"><div id=\"movediv\">End If</div></li>"));
				break;
				
			//else
			case '|': $( "#editorspace ul" ).append(
						$("<li id=\"moveifelse\" class=\"command ui-draggable-handle item\"><div id=\"movediv\">Else</div></li>"));
				break;
			//variables
			case 'i': 
			case 'j':
			...
			//close while
			case ']': $( "#editorspace ul" ).append(
						$("<li id=\"movewhileclose\" class=\"command ui-draggable-handle item\"><div id=\"movediv\">End While</div></li>"));
				break;
			//open for
			case '(': $( "#editorspace ul" ).append(
			...
			//close for
			case ')': $( "#editorspace ul" ).append(
						$("<li id=\"moveforclose\" class=\"command ui-draggable-handle item\"><div id=\"movediv\">End For</div></li>"));
				break;
		}
	}
}
