	...
	for( i = 0 ; i < movearray.length ; i++)
	{
		...
		{			
			...
			case 'U': $( "#editorspace ul" ).append(
						$("<li id=\"moveup\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">MOVE UP: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//down
			case 'D': $( "#editorspace ul" ).append(
						$("<li id=\"movedown\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">MOVE DOWN: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//left
			case 'L': $( "#editorspace ul" ).append(
						$("<li id=\"moveleft\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">MOVE LEFT: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//right
			case 'R': $( "#editorspace ul" ).append(
						$("<li id=\"moveright\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">MOVE RIGHT: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
				
			//open loop
			case 'O': $( "#editorspace ul" ).append(
						$("<li id=\"moveloopo\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">OPEN LOOP</div></li>"));
				break;
				
			//close loop
			case 'C': $( "#editorspace ul" ).append(
						$("<li id=\"moveloopc\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">CLOSE LOOP: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;
			
			//set X
			case 'X': $( "#editorspace ul" ).append(
						$("<li id=\"movesetx\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">SET X: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>")); 
				break;
				
			//set y
			case 'Y': $( "#editorspace ul" ).append(
						$("<li id=\"movesety\" class=\"ui-draggable-handle item\">	<div id=\"movediv\">SET Y: <input type=\"number\" name=\"edittxt\" id=\"edittxt\" value=" + number + " max=\"999\" min=\"-999\" /></div></li>"));
				break;			
				
			//change character
			case 'A': $( "#editorspace ul" ).append(
						$("<li id=\"movechangechar\" class=\"ui-draggable-handle item\"><select id=\"defaultCharListCom\" class=\"characterSelected\"><option value=\"\" disabled selected>Change char</option><option value=\"1\">Yellow Mouse</option><option value=\"2\">Orange Lizard</option><option value=\"3\">Green Elf</option><option value=\"4\">Blue Turtle</option><option value=\"5\">Larry</option></select></li>"));
						$("#editorspace ul li").last().find("#defaultCharListCom").val(number);
				break;
				
			//change background
			case 'B': $( "#editorspace ul" ).append(
						$("<li id=\"movebackground\" class=\"ui-draggable-handle item\"><select id=\"movebackgroundlist\" class=\"backgroundSelectedCom\"><option value=\"\" disabled selected>Background</option><option value=\"#cccccc\" class=\"Grey\">Grey</option><option value=\"#000000\" class=\"Black\">Black</option><option value=\"#ffffff\" class=\"White\">White</option><option value=\"#0000ff\" class=\"Blue\">Blue</option><option value=\"#ff0000\" class=\"Red\">Red</option><option value=\"#00ff00\" class=\"Green\">Green</option><option value=\"#ffff00\" class=\"Yellow\">Yellow</option><option value=\"#00ffff\" class=\"Cyan\">Cyan</option><option value=\"#ff69b4\" class=\"Pink\">Pink</option><option value=\"#c8a2c8\" class=\"Lilac\">Lilac</option></select></li>"));
			...
			//close for
			case ')': $( "#editorspace ul" ).append(
						$("<li id=\"moveforclose\" class=\"ui-draggable-handle item\"><div id=\"movediv\">End For</div></li>"));
				break;
		}
	}
}
